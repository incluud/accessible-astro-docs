...
<Aside type="tip" title="GitHub template">
  Both the starter and dashboard are also available as a GitHub template. You can use it to create a new project by clicking the "Use this template" button in the repository.
</Aside>
