...
<div class="not-content">
  <div style="display: flex; flex-direction: column; gap: 1.5rem;">
    <div style="display: flex; align-items: center; gap: 1rem;">
      <Avatar 
        img="https://images.unsplash.com/photo-1602620502036-e52519d58d92?auto=format&w=400&q=100"
        size="md"
        label="User profile"
      />
      <Avatar 
  ...
  <p style="margin-top: 0.5rem; font-size: 0.9rem;">The Avatar component handles different content types and automatically provides accessible fallbacks.</p>
</div>
