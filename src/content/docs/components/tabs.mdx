...
import AccessibleTabs from '../../../components/Tabs.astro';
...
The Tabs component prioritizes accessibility through several features:
...
The Tabs component comes with a default style that supports both light and dark modes.
