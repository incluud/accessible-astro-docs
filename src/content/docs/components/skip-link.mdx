...
<Aside type="tip" title="Best practice">
  Place the SkipLink component as the first focusable element on your page, before any navigation or content. Preferably in the `head` section of your document.
</Aside>
